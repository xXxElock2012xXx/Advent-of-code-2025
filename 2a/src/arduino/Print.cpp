...
size_t Print::print(uint64_t b, int base) {
  size_t retval = 0;
  if ((unsigned long)((b & 0xffff0000U) >> 32) != 0) {

    retval = print((unsigned long)((b & 0xffff0000U) >> 32), base);
  }
  retval += print((unsigned long)(b & 0x0000ffffU), base);
  return retval;
}
